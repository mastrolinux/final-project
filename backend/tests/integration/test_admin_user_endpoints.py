...
class TestAdminUserEndpoints:
    ...
    def test_list_soft_deleted_users_empty(self, client: TestClient, admin_token: str):
    ...
    def test_list_soft_deleted_users_as_non_admin(self, client: TestClient, regular_token: str):
    ...
    def test_list_soft_deleted_users_unauthenticated(self, client: TestClient):
        """Unauthenticated requests are rejected."""
        response = client.get("/api/v1/admin/users/soft-deleted")
        assert response.status_code == 401

    def test_list_soft_deleted_users_excludes_active(
        self, client: TestClient, admin_token: str, soft_deleted_user, admin_user
    ):
    ...
    def test_purge_expired_as_non_admin(self, client: TestClient, regular_token: str):
