...
The project is named CoBI, an acronym for Context-Based Identity. The name reflects the system's design principle: identity is not a fixed, singular record but a context-dependent construct that users control and present differently depending on the situation.
...
To complement the qualitative interview findings, a formal usability evaluation was conducted using the System Usability Scale (SUS), a ten-item questionnaire developed by Brooke [@brooke1996sus] that has become the industry standard for rapid usability assessment. Six participants were recruited through online communities focused on digital privacy and identity protection, the same recruitment channels used for the earlier interviews but with no participant overlap. Participants ranged in age from 25 to 54 and spanned three technical literacy levels: one beginner, three intermediate, and two advanced users. Prior experience with identity management tools varied: two participants had never used such tools, two used them occasionally, and two used them regularly. @tbl-sus-demographics in Appendix D provides full participant demographics.
...
|-------------|----------------|-----------|-------------------|-----------------|
| P1 | Intermediate | 70.0 | Good | 3 of 5 |
| P2 | Advanced | 80.0 | Good | 5 of 5 |
| P3 | Advanced | 92.5 | Excellent | 5 of 5 |
| P4 | Intermediate | 95.0 | Excellent | 5 of 5 |
| P5 | Beginner | 30.0 | Poor | 2 of 5 |
| P6 | Intermediate | 72.5 | Good | 4 of 5 |

: SUS scores by participant with task completion rates {#tbl-sus-scores}

The mean SUS score was 73.3 (SD = 22.2), placing the system in the "acceptable" range. The high standard deviation reflects a bimodal distribution: five participants scored between 70.0 and 95.0, while P5 (beginner, no prior identity tool experience) scored 30.0. Excluding P5, the remaining five participants achieved a mean of 82.0 (SD = 10.5), corresponding to a "good" rating. P5 required facilitator hints to locate the consent revocation interface and could not independently complete the OAuth authorization task, indicating that the multi-context model requires onboarding support for non-technical users.
...
Seven objectives were defined in @sec-introduction. Evaluation evidence supports achievement of all seven. The SUS evaluation (@tbl-sus-scores) yielded a mean score of 73.3 (SD = 22.2), placing the system in the "acceptable" range per the Bangor et al. adjective scale [@bangor2009sus]. Three of the five improvement tasks identified during usability testing were resolved before final submission, with the consent revocation discoverability fix representing the most significant UX change: the Settings navigation was restructured from a single page link into a dropdown menu grouping General settings, Connected Apps, and Data Export.
...
# Appendix D: Usability Testing Results {-}

This appendix presents detailed results from the System Usability Scale (SUS) evaluation conducted with six participants. The study followed a moderated think-aloud protocol with five representative tasks covering account registration, context profile management, OAuth consent, consent revocation, and data export. Scores were computed per Brooke [@brooke1996sus] and interpreted using the Bangor et al. [@bangor2009sus] adjective rating scale.

## Participant Demographics {-}

| ID | Age Range | Technical Literacy | Prior Identity Tool Use | Occupation |
|----|-----------|-------------------|------------------------|------------|
| P1 | 30-34 | Intermediate | Occasionally | Software Developer |
| P2 | 35-39 | Advanced | Regularly | Security Consultant |
| P3 | 25-29 | Advanced | Regularly | UX Designer |
| P4 | 40-44 | Intermediate | Occasionally | Project Manager |
| P5 | 45-54 | Beginner | Never | Administrative Assistant |
| P6 | 25-29 | Intermediate | Never | Graduate Student |

: Participant demographics for SUS evaluation {#tbl-sus-demographics}

## Individual SUS Scores {-}

| ID | Score | Grade | Adjective Rating | Percentile Range |
|----|-------|-------|-------------------|------------------|
| P1 | 70.0 | B | Good | 40th-50th |
| P2 | 80.0 | B | Good | 60th-70th |
| P3 | 92.5 | A | Excellent | 95th+ |
| P4 | 95.0 | A | Excellent | 95th+ |
| P5 | 30.0 | F | Poor | Below 5th |
| P6 | 72.5 | B | Good | 50th-60th |

: Individual SUS scores with adjective ratings per Bangor et al. [@bangor2009sus] {#tbl-sus-individual}

Mean: 73.3 (SD = 22.2). Excluding P5: 82.0 (SD = 10.5).

## Task Completion Summary {-}

| Task | P1 | P2 | P3 | P4 | P5 | P6 | Completion Rate |
|------|----|----|----|----|----|----|-----------------|
| 1. Registration | Y | Y | Y | Y | Y | Y | 100% |
| 2. Context creation | Y | Y | Y | Y | N | Y | 83% |
| 3. OAuth consent | N | Y | Y | Y | N | Y | 67% |
| 4. Consent revocation | N | Y | Y | Y | N | N | 50% |
| 5. Data export | Y | Y | Y | Y | Y | Y | 100% |

: Task completion by participant. Y = completed independently, N = required facilitator intervention or abandoned {#tbl-sus-tasks}

Task 4 (consent revocation) had the lowest completion rate. Two participants could not locate the Connected Apps page without assistance. This finding led to restructuring the Settings navigation into a dropdown menu, resolving the discoverability issue.

## Identified Improvements {-}

| Issue | Source | Severity | Status |
|-------|--------|----------|--------|
| Dark mode contrast on OAuth consent screen | P2, P3 | Medium | Resolved |
| Incomplete Italian localization | P6 | Medium | Resolved |
| Consent revocation not discoverable in navigation | P1, P5 | High | Resolved |
| Email verification status not visible during registration | P4, P5 | Low | Resolved |
| OAuth scope names unintuitive (`profile:read:basic`) | P2, P5, P6 | Low | Open |

: Usability improvements identified during SUS evaluation {#tbl-sus-improvements}

Full per-participant session recordings, think-aloud transcripts, and individual SUS questionnaire responses are documented in the supplementary participant results report.
