...
const eventTypeOptions = [
  ...
  {
    value: "auth.email_verification",
    label: t("audit.events.emailVerification"),
  },
  { value: "auth.password_change", label: t("audit.events.passwordChange") },
  {
    value: "auth.password_reset_request",
    label: t("audit.events.passwordResetRequest"),
  },
