...
```json
{
  ...
  "overrides": {
    ...
    "credentials": ["MD", "FACS"],
    "avatar_url": "https://storage/professional-headshot.jpg"
  }
}
```
...
```json
{
  ...
  "overrides": {
    ...
    "avatar_url": "https://storage/casual-photo.jpg"
  }
}
```
...
### Example 3: Third-Party OAuth Integration
...
graph TD
    ...
    subgraph CP_Group["Professional Context Override"]
        ...
        CP --> O4["avatar_url<br/>professional.jpg"]
    end
    ...
    subgraph RP_Group["Resolved Profile"]
        ...
        RP --> R6["avatar_url<br/>professional.jpg<br/>from Override only"]
    end
...
6. **Avatar Exception**: `avatar_url` and `avatar_thumbnail_url` are not inherited from the base profile. If a context lacks an explicit avatar override, the resolved profile returns null for both fields. This prevents the user's base photo from leaking into context-specific profiles consumed by OAuth clients without explicit per-context consent (see ADR-009 in decisions-future.qmd).
...
```json
{
  ...
  "phone": "+1-555-0123",
  "bio": "Board-certified cardiovascular surgeon with 15 years experience",
  "avatar_url": "https://storage.example.com/professional-headshot.jpg",
  "credentials": ["MD", "FACS"],
  "context": "professional",
  "language": "en",
  "created_at": "2024-01-15T10:30:00Z",
...
```json
{
  ...
  "phone": "+1-555-0123",
  "bio": "Love hiking, photography, and craft beer",
  "avatar_url": "https://storage.example.com/casual-photo.jpg",
  "context": "social",
  "language": "en",
  "created_at": "2024-01-15T10:30:00Z",
...
flowchart LR
    ...
    Basic --> Return1[display_name<br/>avatar_url<br/>bio]
...
|-------|---------------|----------|
| `profile:read:basic` | `user_id`, `display_name`, `preferred_name`, `avatar_url`, `bio` | Public sharing (social media) |
