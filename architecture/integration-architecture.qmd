...
## 6.0 Standards Compliance and Alignment
...
|----------|---------|------------------|---------|-------------|
| **OAuth 2.0** | RFC 6749 | Full Compliance | Third-party authorization | None |
...
| **GDPR** | EU 2016/679 | Full Compliance | Privacy and data protection | None |
...
- All flows pass OAuth 2.0 test suite
- Security best practices from RFC 6819 implemented
...
### GDPR (EU 2016/679) - Full Compliance

**Data Subject Rights Implementation:**

| GDPR Article | Right | Implementation |
|--------------|-------|----------------|
| Article 15 | Right to Access | `GET /api/v1/users/{id}/gdpr/export` |
| Article 16 | Right to Rectification | `PATCH /api/v1/users/{id}/profile` |
| Article 17 | Right to Erasure | `DELETE /api/v1/users/{id}` (30-day grace) |
| Article 18 | Right to Restriction | Context visibility controls |
| Article 20 | Right to Data Portability | JSON export with machine-readable format |
| Article 21 | Right to Object | Consent withdrawal endpoints |
| Article 22 | Right to Human Review | No automated decision-making |
...
- Legal basis recorded (consent, contract, legal obligation)
- Retention: 7 years
...
**Decision 1: OAuth 2.0 over SAML**
- **Reason**: Modern REST APIs, mobile-friendly, simpler implementation
- **Standard**: OAuth 2.0 (RFC 6749)
- **Benefit**: Wide third-party support, JSON-based
...
- **Compliance**: Still GDPR-compliant (data minimization)
...
- Run OAuth 2.0 test suite
- Validate token flows
- Test PKCE implementation
- Verify security recommendations (RFC 6819)
...
**Under Consideration:**
- **FHIR (Healthcare)**: If healthcare context expands
- **Schema.org Person**: For SEO/structured data
- **ActivityPub**: For federated identity (long-term)
...
Third-Party Apps ----------------> OAuth 2.0 Server
(LinkedIn, etc.)                    |
...
- [NO] Changing authentication methods
...
## 6.5 Third-Party Integration Points
...
## 6.7 External Service Integration
...
## 6.10 Context-Based API Examples
